...
class Menu(models.Model):
    ...
    pid = models.IntegerField(max_length=20, blank=True, verbose_name="上级菜单ID")
    sort = models.IntegerField(max_length=20, blank=True, verbose_name="排序")
    ...
    type = models.IntegerField(max_length=10, blank=True, verbose_name="菜单类型")
